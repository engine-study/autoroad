...
{
    [System.Serializable]
    public class GrapeleafTable : MUDTable
    {
        public class GrapeleafTableUpdate : RecordUpdate
        {
            public uint? Value;
            public uint? PreviousValue;
        }

        public readonly static string ID = "Grapeleaf";
        ...
        {
            return typeof(GrapeleafTable);
        }

        public override Type TableUpdateType()
        {
            return typeof(GrapeleafTableUpdate);
        }

        public override bool Equals(object? obj)
        {
            GrapeleafTable other = (GrapeleafTable)obj;
        ...
        public static IObservable<RecordUpdate> GetGrapeleafTableUpdates()
        {
            GrapeleafTable mudTable = new GrapeleafTable();
        ...
        public override RecordUpdate RecordUpdateToTyped(RecordUpdate recordUpdate)
        {
            ...
            return new GrapeleafTableUpdate
            {
