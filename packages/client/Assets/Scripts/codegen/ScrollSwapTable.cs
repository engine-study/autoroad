...
namespace mudworld
{
    public class ScrollSwapTable : IMudTable
    {
        ...
        public readonly static string ID = "ScrollSwap";
        ...
        {
            return typeof(ScrollSwapTable);
        }

        public override Type TableUpdateType()
        {
            return typeof(ScrollSwapTableUpdate);
        }

        public override bool Equals(object? obj)
        {
            ScrollSwapTable other = (ScrollSwapTable)obj;
        ...
        public static IObservable<RecordUpdate> GetScrollSwapTableUpdates()
        {
            ScrollSwapTable mudTable = new ScrollSwapTable();
        ...
        public override RecordUpdate RecordUpdateToTyped(RecordUpdate recordUpdate)
        {
            ...
            return new ScrollSwapTableUpdate
            {
