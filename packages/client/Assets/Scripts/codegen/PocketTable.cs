...
{
    [System.Serializable]
    public class PocketTable : MUDTable
    {
        public class PocketTableUpdate : RecordUpdate
        {
            public bool? Value;
            public bool? PreviousValue;
        }

        public readonly static string ID = "Pocket";
        ...
        {
            return typeof(PocketTable);
        }

        public override Type TableUpdateType()
        {
            return typeof(PocketTableUpdate);
        }

        public override bool Equals(object? obj)
        {
            PocketTable other = (PocketTable)obj;
        ...
        public static IObservable<RecordUpdate> GetPocketTableUpdates()
        {
            PocketTable mudTable = new PocketTable();
