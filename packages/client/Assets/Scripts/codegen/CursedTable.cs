...
namespace mudworld
{
    public class CursedTable : MUDTable
    {
        public class CursedTableUpdate : RecordUpdate
        {
            public uint? Value;
            public uint? PreviousValue;
        }

        public readonly static string ID = "Cursed";
        ...
        {
            return typeof(CursedTable);
        }

        public override Type TableUpdateType()
        {
            return typeof(CursedTableUpdate);
        }

        public override bool Equals(object? obj)
        {
            CursedTable other = (CursedTable)obj;
        ...
        public static IObservable<RecordUpdate> GetCursedTableUpdates()
        {
            CursedTable mudTable = new CursedTable();
