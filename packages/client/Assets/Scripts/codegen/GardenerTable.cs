...
{
    [System.Serializable]
    public class GardenerTable : MUDTable
    {
        public class GardenerTableUpdate : RecordUpdate
        {
            public uint? Value;
            public uint? PreviousValue;
        }

        public readonly static string ID = "Gardener";
        ...
        {
            return typeof(GardenerTable);
        }

        public override Type TableUpdateType()
        {
            return typeof(GardenerTableUpdate);
        }

        public override bool Equals(object? obj)
        {
            GardenerTable other = (GardenerTable)obj;
        ...
        public static IObservable<RecordUpdate> GetGardenerTableUpdates()
        {
            GardenerTable mudTable = new GardenerTable();
        ...
        public override RecordUpdate RecordUpdateToTyped(RecordUpdate recordUpdate)
        {
            ...
            return new GardenerTableUpdate
            {
