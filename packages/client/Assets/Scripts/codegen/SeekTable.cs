...
namespace mudworld
{
    public class SeekTable : MUDTable
    {
        public class SeekTableUpdate : RecordUpdate
        {
            public int? Value;
            public int? PreviousValue;
        }

        public readonly static string ID = "Seek";
        ...
        {
            return typeof(SeekTable);
        }

        public override Type TableUpdateType()
        {
            return typeof(SeekTableUpdate);
        }

        public override bool Equals(object? obj)
        {
            SeekTable other = (SeekTable)obj;
        ...
        public static IObservable<RecordUpdate> GetSeekTableUpdates()
        {
            SeekTable mudTable = new SeekTable();
