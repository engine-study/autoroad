...
namespace mudworld
{
    public class AnimalTable : MUDTable
    {
        public class AnimalTableUpdate : RecordUpdate
        {
            public bool? Value;
            public bool? PreviousValue;
        }

        public readonly static string ID = "Animal";
        ...
        {
            return typeof(AnimalTable);
        }

        public override Type TableUpdateType()
        {
            return typeof(AnimalTableUpdate);
        }

        public override bool Equals(object? obj)
        {
            AnimalTable other = (AnimalTable)obj;
        ...
        public static IObservable<RecordUpdate> GetAnimalTableUpdates()
        {
            AnimalTable mudTable = new AnimalTable();
