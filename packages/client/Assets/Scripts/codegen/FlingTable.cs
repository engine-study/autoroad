...
namespace mudworld
{
    public class FlingTable : MUDTable
    {
        public class FlingTableUpdate : RecordUpdate
        {
            public uint? Value;
            public uint? PreviousValue;
        }

        public readonly static string ID = "Fling";
        ...
        {
            return typeof(FlingTable);
        }

        public override Type TableUpdateType()
        {
            return typeof(FlingTableUpdate);
        }

        public override bool Equals(object? obj)
        {
            FlingTable other = (FlingTable)obj;
        ...
        public static IObservable<RecordUpdate> GetFlingTableUpdates()
        {
            FlingTable mudTable = new FlingTable();
