...
{
	//Apparently removing Mainnet ,Testnet and Cyan from this enum breaks the login process
	public enum Network
	{
		MAINNET,
		TESTNET,
	...
	public void Init(string clientId, string redirectUri, Network network)
	{
