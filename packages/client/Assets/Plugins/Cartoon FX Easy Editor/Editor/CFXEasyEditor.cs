	...
	*/
	...
	//----------------------------------------------------------------
		...
		if(copyFoldout)
		{
			...
			EditorGUILayout.HelpBox("Copy selected modules from a Particle System to others!", UnityEditor.MessageType.Info);
	...
	void DrawSelectableModules(ref bool[] selected, ref bool[] enabled, ParticleSystem target)
	{
		...
		{
			EditorGUILayout.HelpBox("Select a Particle System to initialize the module list.", UnityEditor.MessageType.Info);
		}
	}
